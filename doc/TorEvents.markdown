...
introduction protocols (v2 only). This is not the same as
HiddenServiceVersionNumber.

All current Tor versions advertise and support:
* Intro version 2: no authentication
* Intro version 3: adds basic and stealth authentication

Protocol versions 0 and 1 are no longer supported.

This field is currently 16 bits. Tor can generate descriptors with versions
0-7, and parses descriptors with versions 0-15. (See Tor Trac bug #22534.)
