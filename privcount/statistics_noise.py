...
def get_noise_allocation_stats(epsilon, delta, stats_parameters,
    ...
    noise_parameters['noise']['epsilon'] = epsilon
    noise_parameters['noise']['delta'] = delta
    noise_parameters['noise']['excess_noise_ratio'] = excess_noise_ratio
    if sigma_tol is not None:
        noise_parameters['noise']['sigma_tolerance'] = sigma_tol
    if epsilon_tol is not None:
        noise_parameters['noise']['epsilon_tolerance'] = epsilon_tol
    if sigma_ratio_tol is not None:
        noise_parameters['noise']['sigma_ratio_tolerance'] = sigma_ratio_tol
...
def compare_noise_allocation(epsilon, delta, stats_parameters,
    ...
    # base results
    assert noise_parameters['noise']['sigma_ratio'] == sigma_ratio
    np_excess_noise_ratio = noise_parameters['noise']['excess_noise_ratio']
