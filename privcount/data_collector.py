...
class Aggregator(ReconnectingClientFactory):
    ...
    def _increment_stream_end_counters(self, subcategory,
        ...
        self._increment_stream_end_histograms(self, subcategory,
                                              totalbw, writebw, readbw,
                                              ratio, lifetime)
    ...
    def _handle_stream_event(self, items):
        ...
        if host_ip_version == "Hostname":
            ...
            self._increment_stream_end_count_lists(self, "DomainExactMatch",
                                                   domain_exact_match_bin_list,
                                                   totalbw, writebw, readbw)
            self._increment_stream_end_count_lists(self, "DomainExactMatch" + stream_circ,
                                                   domain_exact_match_bin_list,
                                                   totalbw, writebw, readbw)
            self._increment_stream_end_count_lists(self, "DomainSuffixMatch",
                                                   domain_suffix_match_bin_list,
                                                   totalbw, writebw, readbw)
            self._increment_stream_end_count_lists(self, "DomainSuffixMatch" + stream_circ,
                                                   domain_suffix_match_bin_list,
                                                   totalbw, writebw, readbw)
