...
class Aggregator(ReconnectingClientFactory):
    ...
    def _handle_stream_event(self, items):
        ...
        self.secure_counters.increment('ExitStreamOutboundByteCount', SINGLE_BIN, writebw)
        self.secure_counters.increment('ExitStreamInboundByteCount', SINGLE_BIN, readbw)
        ...
        if stream_class == 'web':
            ...
            self.secure_counters.increment('ExitWebStreamOutboundByteCount', SINGLE_BIN, writebw)
            self.secure_counters.increment('ExitWebStreamInboundByteCount', SINGLE_BIN, readbw)
            ...
            self.secure_counters.increment('ExitInteractiveStreamOutboundByteCount', SINGLE_BIN, writebw)
            self.secure_counters.increment('ExitInteractiveStreamInboundByteCount', SINGLE_BIN, readbw)
            ...
            self.secure_counters.increment('ExitP2PStreamOutboundByteCount', SINGLE_BIN, writebw)
            self.secure_counters.increment('ExitP2PStreamInboundByteCount', SINGLE_BIN, readbw)
            ...
            self.secure_counters.increment('ExitOtherPortStreamOutboundByteCount', SINGLE_BIN, writebw)
            self.secure_counters.increment('ExitOtherPortStreamInboundByteCount', SINGLE_BIN, readbw)
